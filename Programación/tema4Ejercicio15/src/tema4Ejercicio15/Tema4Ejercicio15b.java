...
public class Tema4Ejercicio15b {
	
	static float calcularMediaEvaluaciones(float ev1, float ev2, float ev3) { //A ver si me acuerdo de que los tipos coincidan
	...
	public static void main(String[] args) {
		...
		float media=Tema4Ejercicio15b.calcularMediaEvaluaciones(nota1, nota2, nota3);
