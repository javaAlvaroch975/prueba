...
public class Tema3Ejercicio27 {
	...
	public static void main(String[] args) {
		...
		System.out.println(nombre1+" ha inflingido "+danyo2+" a "+nombre2+". "+nombre2+" tiene "+vidarestante2+" de vida");
		if (vidarestante2<=0) {
			System.out.println(nombre2+" se desmayó y perdió la batalla");
		} else {
		System.out.println(nombre2+" responde con "+danyo1+" de daño a "+nombre1+" . "+nombre1+" tiene "+vidarestante1+" de vida.");
		
		if (vidarestante1<=0) {
			System.out.println(nombre1+" se desmayó y perdió la batalla");
		}
		}
	}//Aún falta el evitar hacer daño negativo
